...
import com.sias.commons.model.CourseclassStu;
import com.sias.commons.model.ExamGrade;
import com.sias.commons.model.ExamPaperAnswer;
...
implements ExamGradeService{
  ...
  public void releaseExam(ExamGradeRequestVM requestVM) {
    ...
    examGrade.setTitle(requestVM.getTitle());
    ...
    if (requestVM.getId()!=null){
      examGradeMapper.updateByPrimaryKey(examGrade);
    }
  }
